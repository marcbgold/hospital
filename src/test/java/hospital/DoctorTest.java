...
public class DoctorTest {
	...
	private static final int SALARY = 90000;
	...
	public void shouldDrawBloodFromDouble() {
		BloodDrawer underTest = new Doctor(NAME, ID_NUM, SALARY, SPECIALTY);
	...
	public void shouldHaveSalary() {
		Employee underTest = new Doctor(NAME, ID_NUM, SALARY, SPECIALTY);
